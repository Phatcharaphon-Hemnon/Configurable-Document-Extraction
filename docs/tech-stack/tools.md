...
| LLM providers | 14 `LLM_PROVIDERS` entries | Model backends behind 3 env vars |
...
`docs/reference/schemas.md`, `docs/reference/extraction_response_contract.md`.
...
(`MAX_UPLOAD_MB=10`). See `docs/guides/ai_provider.md`.
...
(`docs/guides/api_scripts.md`). See `docs/guides/ai_provider.md`,
`docs/reference/llm_request_queue.md`, `docs/reference/provider_errors.md`.
...
(gateway, ships no default model — `LLM_MODEL` required), `groq`
(`openai/gpt-oss-20b` @ temperature 0.6). No native
...
SHA-256 in-memory result cache. See `docs/guides/local_ocr.md`.
...
`docs/reference/database.md`, `docs/reference/async_jobs.md`.
...
`docs/guides/langfuse_tracing.md`.
...
`docs/reference/frontend.md`, `docs/reference/frontend_helpers.md`.
...
`docs/reference/rag_kb.md`, `docs/reference/catalog_review.md`.
