...
Source: `eval_final/eval_artifacts/predictions.json`. Total validation/judge flags: **60** across 14 pages, review rate 9/14 (64.3%).
...
| ocr-noise | 8 | tokens overlap ≥0.75 but substring fails (spacing/OCR errors) | Phase 1 (OCR-tolerant match) |
...
| genuine-mismatch | 26 | value tokens absent from doc — real model errors | Phase 2 (prompt/model) |
...
| Invoice+purchase.pdf p1 | invoice | 12 | genuine-mismatch×9, judge-score<0.7×1, other×3 |
...
| THAI_RECEIPT.jpg p1 | invoice | 15 | date-format×1, genuine-mismatch×6, judge×1, ocr-noise×3, other×4 |
| THAI_bill.jpg p1 | invoice | 8 | judge-score<0.7×1, ocr-noise×4, other×4 |
...
- THAI_bill.jpg p1: line_items span='๑อเค | ชา. DI ชาเขียวนม sau ขนาดใหญ่ | 1 | 60.00 - DI 0% | pees OD,'
- THAI_bill.jpg p1: line_items span='๑อเค | ชา. DI ชาเขียวนม sau ขนาดใหญ่ | 1 | 60.00 - DI 0% | pees OD,'
