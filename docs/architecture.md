...
| Stage | Type | Purpose |
|---|---|---|
| Parse | deterministic | Local RapidOCR (ONNX, CPU, offline): images OCR'd directly, PDFs rendered at 300 DPI via PyMuPDF then OCR'd per page. One result per page → multi-document PDFs work. |
